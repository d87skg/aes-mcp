#!/usr/bin/env python3
"""AES Golden Trace Benchmark v0.1.1"""
import json, os, sys
...
def run():
    ...
    for trace in manifest["traces"]:
        ...
        results.append({"trace_id": tid, "category": trace["category"], "expected_score": exp_score, "actual_score": act_score, "deviation": dev, "expected_grade": exp_grade, "actual_grade": act_grade, "grade_match": match, "cpf": scored["experimental_metrics"]["cpf"]})
    print("\n" + "=" * 85)
